...
const Tile = (props) => {
  ...
  const isClose =
    !isCorrect && props.letterValue !== "" && solution.includes(letterValue);
  ...
  const letterStyle =
    currInput.attempt > props.attemptValue &&
    (isCorrect ? styles.correct : isClose ? styles.almost : styles.error);
